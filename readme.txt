...
With a few simple clicks, you can post a customized, interactive Google Map in your
blog. Follow these simple steps to post your map:

* Go to the ZeeMaps server (http://www.zeemaps.com) and create your map
...
1. Upload and unzip `zeemaps.zip` in the `/wp-content/plugins/` directory
...
1. Shows the ZeeMaps plugin listed in the Plugins Admin page.
2. The Google Marker icon button for adding a ZeeMap to your blog.
3. Dialog to customize your published map.
